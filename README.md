...
Portfolio personal de [Luis Romero](https://www.linkedin.com/in/15-luis-romero), AI Engineer y Backend Developer con base en Barranquilla, Colombia. Construido con HTML/CSS/JS vanilla — sin frameworks. Incluye un **agente conversacional RAG** embebido en producción, un terminal interactivo CLI, y estadísticas en vivo de [Cronix](https://cronix-app.vercel.app) sincronizadas automáticamente desde su repositorio via GitHub Actions.
