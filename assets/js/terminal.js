  ...
  const content = {
    en: {
      ...
      whoami: [
        ...
        { t: 'empty' },
        { t: 'output', v: '3 years building and operating AI products in production.' },
      ...
      contact: [
        ...
        { t: 'output', v: '  LinkedIn   linkedin.com/in/luis-romero-dev15' },
    ...
    es: {
      ...
      whoami: [
        ...
        { t: 'output', v: 'Barranquilla, Colombia' },
        { t: 'empty' },
        { t: 'output', v: '3 años construyendo y operando productos de IA en producción.' },
